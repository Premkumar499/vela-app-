...
class _BilingualBillDashboardState extends State<BilingualBillDashboard> {
  ...
  String _receiptLanguage = 'bilingual';
  ...
  void initState() {
    ...
    // Auto-translate all item names to Tamil on open
  ...
  /// Auto-translate all item names that have no Tamil yet.
        ...
        child: CustomPaint(
          ...
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, mainAxisSize: MainAxisSize.min, children: [
              ...
              const Center(child: Text('INVOICE / CASH BILL',
  ...
  Widget _tableHeader() {
    return const Row(children: [
      SizedBox(width: 28, child: Text('SNo',
          style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.black87))),
      Expanded(flex: 4, child: Text('Description / விவரம்',
          style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.black87))),
      ...
      SizedBox(width: 56, child: Text('Rate',
          textAlign: TextAlign.right,
          style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.black87))),
      SizedBox(width: 64, child: Text('Amount',
          textAlign: TextAlign.right,
          style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.black87))),
    ]);
  }
          ...
          Padding(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_receiptLanguage == 'bilingual' && ta.isNotEmpty)
              ...
              SizedBox(width: 64, child: Text(
                  amt is double ? amt.toStringAsFixed(2) : '$amt',
                  textAlign: TextAlign.right,
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      if (_totalWeight > 0) ...[
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          Text('${_totalWeight.toStringAsFixed(3)} kg',
              style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.black87)),
        ]),
      ],
    ]);
  ...
  Widget _divider(String char, {double spacing = 1.0, Color color = Colors.black87}) => Text(
    char * 80, maxLines: 1, softWrap: false, overflow: TextOverflow.clip,
...
class _SawToothPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    const tw = 8.0; const th = 5.0;
    final paint = Paint()..color = const Color(0xFFF9F6EE)..style = PaintingStyle.fill;
    final path = Path();
    path.moveTo(0, th);
    for (double x = 0; x < size.width; x += tw) {
      path.lineTo(x + tw / 2, 0); path.lineTo(x + tw, th);
    }
    path.lineTo(size.width, size.height - th);
    for (double x = size.width; x > 0; x -= tw) {
      path.lineTo(x - tw / 2, size.height); path.lineTo(x - tw, size.height - th);
    }
    path.lineTo(0, th); path.close();
