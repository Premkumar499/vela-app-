...
class BillingService:
    ...
    def __init__(self) -> None:
        self._products: list[Product] = list(SAMPLE_PRODUCTS)
        self._customers: list[Customer] = list(SAMPLE_CUSTOMERS)
    ...
    def search_customers(self, query: str) -> list[dict]:
        ...
        return [
            ...
            if q in c.name.lower() or q in c.phone or q in c.area.lower()
        ]
